...
class GeminiRawClassification(BaseModel):
    parent_category: str = Field(
        description="Parent category code (e.g. LARGE_APPLIANCE, DISPLAY, COMPUTING, MOBILE, PCB, CABLE, BATTERY, SMALL_APPLIANCE, PAPER, PLASTIC, METAL_FERROUS, METAL_NONFERROUS, GLASS, TEXTILE, RUBBER_OTHER)"
    )
